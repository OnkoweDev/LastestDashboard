  ...
  return (
    <div className='w-full py-10 px-8 bg-[#FFFFFF]'>
            ...
            <div className='w-full flex flex-col text-center justify-center items-center'>
                ...
                <p className='pt-5 font-bold'>Begin with a Seven day Trail Period</p>
                <p className=' pt-5 font-bold text-3xl'> Monthly/Annual ( Save 20% on annual subscription)</p> 
        ...
        <div className='max-w-[1240px] py-[3rem] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full border border-gray-200 shadow-xl flex flex-col p-4 my-4 rounded-xl hover:scale-105 duration-300'>              
                <h2 className='text-1xl font-bold text-center py-8 border-b'>STARTER PLAN ($10)</h2>
            ...
            <div className='w-full border border-gray-200 shadow-xl flex flex-col p-4 my-4 rounded-xl hover:scale-105 duration-300'>
            <h2 className='text-1xl font-bold text-center py-8 border-b'>ELITE PLAN ($15)</h2>
            <div className='text-center text-1xl font-bold pt-3 border-b p-2'>
        ...
        <div className='w-full border border-gray-200 shadow-xl flex flex-col p-4 my-4 rounded-xl hover:scale-105 duration-300'>
                <h2 className='text-1xl font-bold text-center py-8 border-b'>PROFESSIONAL PLAN ($25)</h2>
                <div className='text-center text-1xl font-bold pt-3 border-b p-2'>
                    <p>250k Words</p> 
