...
export const adduploadAction = (file_name) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.post(`http://3.237.101.152/api/account/${userInfo.data.account_id}/upload`, {file_name},config)
