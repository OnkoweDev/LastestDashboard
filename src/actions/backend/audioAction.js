...
export const addAudioAction = (generated_transcription,project_id,uploaded_url) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.post(`http://3.237.101.152/api/account/${userInfo.data.account_id}/audioTranscription`, {generated_transcription,project_id,uploaded_url},config)
...
export const getAudioAction = () => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.get(`http://3.237.101.152/api/account/${userInfo.data.account_id}/audioTranscription`,config)
...
export const getOneAudioAction = (id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.get(`http://3.237.101.152/api/account/${userInfo.data.account_id}/audioTranscription/${id}`,config)
...
export const deleteAudioAction = (id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.delete(`http://3.237.101.152/api/account/${userInfo.data.account_id}/audioTranscription/${id}`,config)
