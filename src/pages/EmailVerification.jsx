    ...
    const verifyUser = async () => {
      try {
        ...
        if (response.data.status == true) {
          ...
          window.location.href = "http://dashboard.olukowe.co/"; // Redirect to a success page
        } else {
          // Handle verification failure (show an error message, etc.)
          window.location.href = "http://dashboard.olukowe.co/sign-up"; // Redirect to a failure page
        }
      } catch (error) {
