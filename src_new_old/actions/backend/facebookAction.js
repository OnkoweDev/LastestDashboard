...
export const addFacebookAction = (facebook_ad,project_id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.post(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/facebookAd`, {facebook_ad,project_id},config)
...
export const getFacebookAdsAction = () => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.get(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/facebookAd`,config)
...
export const getOneFacebookAdsAction = (id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.get(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/facebookAd/${id}`,config)
...
export const deleteFacebookAdsAction = (id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.delete(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/facebookAd/${id}`,config)
