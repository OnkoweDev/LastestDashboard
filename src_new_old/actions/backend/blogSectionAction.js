...
export const addSectionAction = (section,project_id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.post(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/blogSection`, {section,project_id},config)
...
export const getSectionAction = () => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.get(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/blogSection`,config)
...
export const getOneSectionAction = (id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.get(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/blogSection/${id}`,config)
...
export const deleteSectionAction = (id) => async(dispatch,getState) => {
    try {
        ...
        const {data} = await axios.delete(`https://dev.olukowe.co/api/account/${userInfo.data.account_id}/blogSection/${id}`,config)
